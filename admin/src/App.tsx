...
const menuItems: MenuItem[] = [
  ...
  { key: 'shelters', label: '避难所管理', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>, children: [{ key: 'list', label: '避难所列表' }, { key: 'facilities', label: '设施统计' }, { key: 'reports', label: '纠错反馈' }] },
  ...
  { key: 'mutualaid', label: '互助系统', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="4"/><line x1="2" y1="12" x2="4" y2="12"/><line x1="20" y1="12" x2="22" y2="12"/><line x1="12" y1="2" x2="12" y2="4"/><line x1="12" y1="20" x2="12" y2="22"/></svg>, children: [{ key: 'events', label: '关联SOS事件' }, { key: 'subscriptions', label: '互助订阅' }, { key: 'responses', label: '响应记录' }, { key: 'rewards', label: '积分结算' }, { key: 'analytics', label: '数据分析' }] },
  ...
  { key: 'content', label: '内容管理', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>, children: [{ key: 'announcements', label: '公告管理' }, { key: 'news', label: '安全资讯' }, { key: 'cities', label: '城市管理' }] },
